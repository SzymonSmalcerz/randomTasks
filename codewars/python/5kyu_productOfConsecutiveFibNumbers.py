...
def productFib(prod):
    # your code
    return getProduct(prod,0,1)


def getProduct(finalValue,nthMinusOne,nth):
    while nthMinusOne * nth < finalValue:
        new = nth+nthMinusOne;
        nthMinusOne = nth;
        nth = new;
    if nthMinusOne * nth == finalValue:
        return [nthMinusOne,nth,True]
    else:
        return [nthMinusOne,nth,False]
