/*
	...
	The goal is to create a class that handles finding all the values 
	in the array that are within a given range of each other.
...
class GroupByDifference {
  ...
  find(diffrence){
    return this.numbers.filter((val,index,arr) => arr[index+1] - val <= diffrence || val - arr[index-1] <= diffrence)
  }
