...
function findEvenIndex(arr)
{
  ...
  let sumLeft = 0;
  let sumRight = 0;
  while(middleElementIndex < arr.length - 1){
    sumRight = sumArrayElements(arr.slice(middleElementIndex));
    sumLeft = sumArrayElements(arr.slice(0,middleElementIndex-1));
    if(sumRight == sumLeft){return middleElementIndex - 1}
