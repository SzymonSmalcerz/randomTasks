...
function race(v1, v2, g) {
    ...
    v2 = v2/3600;
    // v1X + g = v2X => X = g/(v1-v2)
    var howManySeconds = Math.floor((g/(v2-v1) + 0.0000001 )%60);
    var howManyMinutes = Math.floor(((g/(v2-v1)+ 0.0000001)%3600 - howManySeconds)/60);
    var howManyHours = (g/(v2-v1) - g/(v2-v1)%3600)/3600
    
    return [howManyHours,howManyMinutes,howManySeconds]
}
