/*
	...
	for 1 and the number itself). If the number is prime return the 
	string '(integer) is prime' (null in C#) (use Either String a 
...
function divisors(integer) {
  ...
  divisors = divisors.concat(divisors.map(val => integer/val).reverse())
