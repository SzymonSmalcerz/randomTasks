/*
	...
	Create a finite automaton that has three states. Finite automatons are the same as 
	finite state machines for our purposes.

	Our simple automaton, accepts the language of A, defined as {0, 1} and should have 
	three states: q1, q2, and q3. Here is the description if the states:
	...
	or a number represented as a string, because the language an automaton can accept 
	isn't confined to just numbers. An automaton should be able to accept any 'symbol.'
...
{
  let that = this;
  commands.forEach(command => command == "0" || command == "1" ? that.currentState = that.states[that.currentState][command] : console.log(":C"));
