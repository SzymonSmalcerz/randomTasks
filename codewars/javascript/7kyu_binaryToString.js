/*
	...
	Write a function which will receive a long string of binary code and convert 
	it to a string. Remember, in Python binary output starts with '0b'.
...
function binaryToString(binary){
  return binary.split("0b").slice(1).map(val => String.fromCharCode(parseInt(val,2))).join("");
}
