/*
	...
	A man has a rather old car being worth $2000. He saw a secondhand 
	car being worth $8000. He wants to keep his old car until he can 
	...
	Furthermore the percent of loss increases by a fixed 0.5 percent at the end of 
	every two months.
	...
	where 6 is the number of months at the end of which he can buy 
	the new car and 766 is the nearest integer to '766.158...' .
	...
	by chance from the start, the value of the old car is bigger than the 
	value of the new one or equal there is no saving to be made, no need 
...
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
  ...
  while(manSavings + priceOldCar < priceNewCar){
    monthsPassed += 1;
    if(monthsPassed %2 == 0){percentLossByMonth += 0.5}
    manSavings += savingperMonth;
    priceOldCar = priceOldCar * (100 - percentLossByMonth)/100;
    priceNewCar = priceNewCar * (100 - percentLossByMonth)/100;
  };
  
  
  return [monthsPassed, Math.round(manSavings + priceOldCar - priceNewCar)];
}
