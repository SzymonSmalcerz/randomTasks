/*
	...
	(The first item) and number of people get off the bus 
	...
	Please keep in mind that the test cases ensure 
	that the number of people in the bus is always >= 0. 
...
var number = function(busStops){
  return busStops.reduce((t,v) => t + v[0] - v[1],0)
}
