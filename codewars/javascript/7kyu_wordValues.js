/*
	...
	the value at position 1 is multiplied by 1 while the value at 
	position 2 is multiplied by 2.
...
function wordValue(a) {
  ...
  return a.map((val,index) => {
    ...
    return (index+1) * val.reduce((total,val) => total + val.charCodeAt(0) - 96,0);
  });
}
